...
if df_daily_rto.empty or df_ndr_by_courier.empty or df_delivery_time.empty:
   ...
   # Best practice also we need to add duckdb in future 
    ...
    action_map = {
        ...
        "Pincode Not Serviceable": "RTO",
        "Wrong Pincode": "Review",
        "Incomplete Address": "Review",
        "Landmark Not Clear": "Review",
        "Recipient Refused Delivery": "Cancel",
        "COD Not Ready": "Review",
        "OTP Verification Failed": "Review",
        "Customer Out of Station": "Review",
        "Office Closed": "Review",
        "Holiday / Non-Working Day": "Review",
        "No Access – Gated Community": "Review",
        "Road Blocked / No Entry": "Review",
        "Traffic Congestion": "Review",
        "Natural Calamity": "Review",
        "Strike / Protest": "Review",
        "Hub / Operations Backlog": "Review",
        "Shipment Misrouted": "Review",
        "Shipment Lost in Transit": "Cancel",
        "Shipment Damaged": "Cancel",
        "KYC/ID Proof Not Available": "Review",
        "Prepaid-Only Zone (COD Blocked)": "Review",
        "Exceeded Reattempt Limit": "RTO",
        "Incorrect Phone Number": "Review",
        "Intercom/Bell Not Working": "Review",
        "Address Flagged / High Risk": "Cancel",
        "Delivery Window Missed": "Review",
        "Unknown": "Review",
    }
